...
- **Gevolgen:** streaming analyse zichtbaar in UI; tickets krijgen `category_id` na analyse; suggesties landen in `ai_suggestions`; chat overleeft navigatie en refresh. PR6 bouwt suggesties-beheer en dashboard-trends.
