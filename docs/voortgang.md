...
en AI-agent (PR5) zijn gebouwd; suggesties-dashboard volgt in PR6. Supabase-project bestaat;
...
- [~] Minimaal 5 pull requests gemerged naar `main` (1.5) — PR1–PR4 gemerged; PR5 in uitvoering
- [x] Repository volgens voorgeschreven structuur
- [ ] Gedeployed op Vercel
- [ ] `README.md` met heldere installatie-instructies
- [~] Minimaal 4 kernfunctionaliteiten (auth + ticket-ingestie + AI-analyse klaar; suggesties-dashboard volgt)
